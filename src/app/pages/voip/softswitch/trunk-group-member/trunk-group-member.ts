...
const CONFIG: ConfigurableCrudConfig = {
  ...
  fields: [
    { key: 'trunkGroupUUID', source: 'trunkGroupUUID', payloadKey: 'trunkGroupUUID', label: 'Trunk group', type: 'search-select', required: true, span: 1 },
    { key: 'trunkUUID', source: 'trunkUUID', payloadKey: 'trunkUUID', label: 'Trunk', type: 'search-select', required: true, span: 1 },
    ...
    { key: 'weight', source: 'weight', payloadKey: 'weight', label: 'Weight', type: 'number', span: 1, tab: 'routing' },

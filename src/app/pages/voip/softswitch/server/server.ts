...
const SERVER_CONFIG: ConfigurableCrudConfig = {
  ...
  columns: [
    ...
    { id: 'publicIP', label: 'SIP public IP (NAT/advertise)', field: 'VsrPublicIP' },
    { id: 'advertisedIP', label: 'SIP advertised IP', field: 'VsrAdvertisedIP', copyable: true },
    { id: 'privateIP', label: 'Private listen IP', field: 'VsrPrivateIP' },

...
export class VoipSbcDashboardPage {
  ...
  readonly metrics = computed<SbcMetric[]>(() => {
    ...
    return [
      ...
      this.metric('pipes', 'Forwarding', 'schema', snapshot.pipes, 'VbpStatus', 'pipe'),
      this.metric(
        'manipulations',
        'Manipulations',
        'transform',
    ...
    return master
      ...
      : [
          ...
          },
          {
            ...
            description: 'Configure SIP destinations and authentication.',
          ...
          },
          {
            key: 'pipe',
            label: 'Forwarding',
            description: 'Bind inbound traffic to outbound destinations.',
            icon: 'schema',

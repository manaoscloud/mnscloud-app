...
const PIPE_CONFIG: ConfigurableCrudConfig = {
  ...
  uuidField: 'VbpUUID',
  pageTitle: 'SBC pipes',
  pageDescription: 'Manage tenant-aware SIP flows from inbound peer to outbound destination.',
  createTitle: 'New SBC pipe',
  editTitle: 'Edit SBC pipe',
  dialogDescription: 'Maintain inbound peer, outbound destination, media and codec behavior.',
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Allowed codecs (empty = inherit from peer)',
      type: 'multi-select',
...
export class VoipSbcPipePage extends ConfigurableCrudPageBase<ConfigurableCrudRecord> {
  ...
  protected override augmentPayload(payload: ConfigurableCrudRecord): ConfigurableCrudRecord {
    return {
      ...
      outputHost:
        String(payload['destinationMode'] || 'peer') === 'manual' ? payload['outputHost'] : null,

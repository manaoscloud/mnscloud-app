...
const PEER_CONFIG: ConfigurableCrudConfig = {
  ...
  uuidField: 'VspUUID',
  pageTitle: 'SIP destinations',
  pageDescription: 'Manage SIP destinations used by SBC forwarding.',
  createTitle: 'New SIP destination',
  editTitle: 'Edit SIP destination',
  dialogDescription: 'Maintain destination connection, authentication and monitoring data.',
  searchPlaceholder: 'Search',
  emptyLabel: 'No SIP destinations found.',
  deleteTitle: 'Delete SIP destination',
  deleteMessage: 'Are you sure you want to delete this SIP destination?',
  deleteSelectedTitle: 'Delete selected SIP destinations',
  deleteSelectedMessage: 'Delete {count} selected SIP destinations?',
  savedMessage: 'SIP destination saved successfully.',
  deletedMessage: 'SIP destination deleted successfully.',
  deleteFailedMessage: 'Failed to delete SIP destination.',
  statusMode: 'number',
  activeValue: 1,
  inactiveValue: 0,
  tabLabels: {

...
export function getVpsDialogViewportConfig() {
...
export function updateVpsDialogViewport(dialogRef: MatDialogRef<unknown>) {
  const config = getVpsDialogViewportConfig();

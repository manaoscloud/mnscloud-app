...

    {
      ...
      children: [
        ...
        },
        {
          ...
          label: 'Fee Plans',
          icon: 'sell',
          masterRoute: '/system/pay/fee-plans',
        },
        {
          id: 'system/pay/fee-plan-assignments',
          label: 'Fee Plan Assignments',
          icon: 'assignment_ind',
          masterRoute: '/system/pay/fee-plan-assignments',
        },
        {
          id: 'system/pay/fee-accruals',
          label: 'Postpaid Accruals',
          icon: 'pending_actions',
          masterRoute: '/system/pay/fee-accruals',
        },
      ],
    },
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  id: 'voip/softswitch/trunks/list',
                  label: 'Trunks',
                  icon: 'settings_input_component',
                  route: '/voip/softswitch/trunks',
                },
                {
                  id: 'voip/softswitch/trunk-groups',
                  label: 'Groups',
                  icon: 'hub',
                  route: '/voip/softswitch/trunk-groups',
                },
                {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              entitlementCode: 'module.hosting.vps-container.instance',
            },
          ],
        },
        {
          ...
          children: [
            {
              id: 'hosting/webhost/dashboard',
              label: 'Dashboard',
              icon: 'dashboard',
              route: '/hosting/webhost',
              masterRoute: '/system/hosting/webhost',
            },
            {
              id: 'hosting/webhost/providers',
              label: 'Providers',
              icon: 'admin_panel_settings',
              masterRoute: '/system/hosting/webhost/providers',
              scope: 'master',
              permissions: ['platform.master.access'],
            },
            {
              ...
              label: 'Plans',
              icon: 'view_list',
              masterRoute: '/system/hosting/webhost/plans',
              scope: 'master',
              permissions: ['platform.master.access'],
            },
            {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              id: 'cyber-security/secret-servers',
              label: 'Servers',
              icon: 'admin_panel_settings',
